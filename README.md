...
Замечания
имена файлов пишем через дефис
лого не является элементом списка, вынести перед
телефон оформить ссылкой со спец значением
по стилю оформления и значению это разные теги
оформить ссылками и объединить в список внутри
